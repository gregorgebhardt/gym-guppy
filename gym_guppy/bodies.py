...
class Body:
    ...
    _linear_damping = .00  # * _world_scale
    _angular_damping = .00  # * _world_scale
    ...
    def set_linear_velocity(self, linear_velocity, local=False):
        if local:
...
class Quad(Body):
    ...
    def plot(self, axes, **kwargs):
        from gym_guppy.tools.plotting import plot_rect
...
class Circle(Body):
    ...
    def plot(self, axes, **kwargs):
        from gym_guppy.tools.plotting import plot_circle
...
class Polygon(Body):
    ...
    def plot(self, axes, **kwargs):
        from gym_guppy.tools.plotting import plot_polygon
